...
// Source file: person_java.proto
package com.squareup.wire.protos.person.java;
...
public final class Person extends Message<Person, Person.Builder> {
  ...
  public static final class PhoneNumber extends Message<PhoneNumber, PhoneNumber.Builder> {
    ...
    @WireField(
        tag = 2,
        adapter = "com.squareup.wire.protos.person.java.Person$PhoneType#ADAPTER"
    )
    ...
    private static final class ProtoAdapter_PhoneNumber extends ProtoAdapter<PhoneNumber> {
      public ProtoAdapter_PhoneNumber() {
        super(FieldEncoding.LENGTH_DELIMITED, PhoneNumber.class, "type.googleapis.com/squareup.protos.kotlin.person.Person.PhoneNumber", Syntax.PROTO_2);
      }
  ...
  private static final class ProtoAdapter_Person extends ProtoAdapter<Person> {
    public ProtoAdapter_Person() {
      super(FieldEncoding.LENGTH_DELIMITED, Person.class, "type.googleapis.com/squareup.protos.kotlin.person.Person", Syntax.PROTO_2);
    }
