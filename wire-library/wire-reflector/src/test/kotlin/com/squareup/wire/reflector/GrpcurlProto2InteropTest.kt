...
internal class GrpcurlProto2InteropTest {
  ...
  fun `list services`() {
    ...
    val respBase64 =
      "Cgtsb2NhbGhvc3Q6MBIPCgtsb2NhbGhvc3Q6MDoAMjoKDAoKZWNobzIuRWNobwoqCihncnBjLnJlZmxlY3Rpb24udjFhbHBoYS5TZXJ2ZXJSZWZsZWN0aW9u=="
  ...
  fun `file_containing_symbol service`() {
    ...
    val expectedResponse =
      ServerReflectionResponse.ADAPTER.decode(ECHO2_FILEDESCRIPTOR_RESPONSE.decodeBase64()!!)
