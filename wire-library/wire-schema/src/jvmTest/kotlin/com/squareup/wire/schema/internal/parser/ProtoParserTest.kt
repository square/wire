...
class ProtoParserTest {
            ...
            RpcElement(
              ...
              options = listOf(
                ...
                OptionElement.create(
                  ...
                  mapOf(
                    "value" to listOf(
                      OptionElement.OptionPrimitive(Kind.ENUM, "FOO"),
                      OptionElement.OptionPrimitive(Kind.ENUM, "BAR")
                    )
                  ),
                  true
                )
  ...
  fun structuredOption() {
    ...
    option_three_nested_map["y"] = Arrays.asList(
      OptionElement.OptionPrimitive(Kind.NUMBER, "1"),
      OptionElement.OptionPrimitive(Kind.NUMBER, "2")
    )
