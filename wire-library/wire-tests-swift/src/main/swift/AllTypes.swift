...
extension _AllTypes : Codable {
    public init(from decoder: Decoder) throws {
        ...
        self.opt_int64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "optInt64", "opt_int64")
        self.opt_uint64 = try container.decodeFirstIfPresent(stringEncoded: UInt64.self, forKeys: "optUint64", "opt_uint64")
        self.opt_sint64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "optSint64", "opt_sint64")
        self.opt_fixed64 = try container.decodeFirstIfPresent(stringEncoded: UInt64.self, forKeys: "optFixed64", "opt_fixed64")
        self.opt_sfixed64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "optSfixed64", "opt_sfixed64")
        ...
        self.opt_bytes = try container.decodeFirstIfPresent(stringEncoded: Data.self, forKeys: "optBytes", "opt_bytes")
        ...
        self.req_int64 = try container.decodeFirst(stringEncoded: Int64.self, forKeys: "reqInt64", "req_int64")
        self.req_uint64 = try container.decodeFirst(stringEncoded: UInt64.self, forKeys: "reqUint64", "req_uint64")
        self.req_sint64 = try container.decodeFirst(stringEncoded: Int64.self, forKeys: "reqSint64", "req_sint64")
        self.req_fixed64 = try container.decodeFirst(stringEncoded: UInt64.self, forKeys: "reqFixed64", "req_fixed64")
        self.req_sfixed64 = try container.decodeFirst(stringEncoded: Int64.self, forKeys: "reqSfixed64", "req_sfixed64")
        ...
        self.req_bytes = try container.decodeFirst(stringEncoded: Data.self, forKeys: "reqBytes", "req_bytes")
        ...
        self.rep_int32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "repInt32", "rep_int32")
        self.rep_uint32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "repUint32", "rep_uint32")
        self.rep_sint32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "repSint32", "rep_sint32")
        self.rep_fixed32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "repFixed32", "rep_fixed32")
        self.rep_sfixed32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "repSfixed32", "rep_sfixed32")
        self.rep_int64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "repInt64", "rep_int64")
        self.rep_uint64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "repUint64", "rep_uint64")
        self.rep_sint64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "repSint64", "rep_sint64")
        self.rep_fixed64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "repFixed64", "rep_fixed64")
        self.rep_sfixed64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "repSfixed64", "rep_sfixed64")
        self.rep_bool = try container.decodeFirstProtoArray(Bool.self, forKeys: "repBool", "rep_bool")
        self.rep_float = try container.decodeFirstProtoArray(Float.self, forKeys: "repFloat", "rep_float")
        self.rep_double = try container.decodeFirstProtoArray(Double.self, forKeys: "repDouble", "rep_double")
        self.rep_string = try container.decodeFirstProtoArray(String.self, forKeys: "repString", "rep_string")
        self.rep_bytes = try container.decodeFirstProtoArray(stringEncoded: Data.self, forKeys: "repBytes", "rep_bytes")
        self.rep_nested_enum = try container.decodeFirstProtoArray(AllTypes.NestedEnum.self, forKeys: "repNestedEnum", "rep_nested_enum")
        self.rep_nested_message = try container.decodeFirstProtoArray(AllTypes.NestedMessage.self, forKeys: "repNestedMessage", "rep_nested_message")
        self.pack_int32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "packInt32", "pack_int32")
        self.pack_uint32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "packUint32", "pack_uint32")
        self.pack_sint32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "packSint32", "pack_sint32")
        self.pack_fixed32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "packFixed32", "pack_fixed32")
        self.pack_sfixed32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "packSfixed32", "pack_sfixed32")
        self.pack_int64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "packInt64", "pack_int64")
        self.pack_uint64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "packUint64", "pack_uint64")
        self.pack_sint64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "packSint64", "pack_sint64")
        self.pack_fixed64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "packFixed64", "pack_fixed64")
        self.pack_sfixed64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "packSfixed64", "pack_sfixed64")
        self.pack_bool = try container.decodeFirstProtoArray(Bool.self, forKeys: "packBool", "pack_bool")
        self.pack_float = try container.decodeFirstProtoArray(Float.self, forKeys: "packFloat", "pack_float")
        self.pack_double = try container.decodeFirstProtoArray(Double.self, forKeys: "packDouble", "pack_double")
        self.pack_nested_enum = try container.decodeFirstProtoArray(AllTypes.NestedEnum.self, forKeys: "packNestedEnum", "pack_nested_enum")
        ...
        self.default_int64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "defaultInt64", "default_int64")
        self.default_uint64 = try container.decodeFirstIfPresent(stringEncoded: UInt64.self, forKeys: "defaultUint64", "default_uint64")
        self.default_sint64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "defaultSint64", "default_sint64")
        self.default_fixed64 = try container.decodeFirstIfPresent(stringEncoded: UInt64.self, forKeys: "defaultFixed64", "default_fixed64")
        self.default_sfixed64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "defaultSfixed64", "default_sfixed64")
        ...
        self.default_bytes = try container.decodeFirstIfPresent(stringEncoded: Data.self, forKeys: "defaultBytes", "default_bytes")
        ...
        self.ext_opt_int64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "extOptInt64", "ext_opt_int64")
        self.ext_opt_uint64 = try container.decodeFirstIfPresent(stringEncoded: UInt64.self, forKeys: "extOptUint64", "ext_opt_uint64")
        self.ext_opt_sint64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "extOptSint64", "ext_opt_sint64")
        self.ext_opt_fixed64 = try container.decodeFirstIfPresent(stringEncoded: UInt64.self, forKeys: "extOptFixed64", "ext_opt_fixed64")
        self.ext_opt_sfixed64 = try container.decodeFirstIfPresent(stringEncoded: Int64.self, forKeys: "extOptSfixed64", "ext_opt_sfixed64")
        ...
        self.ext_opt_bytes = try container.decodeFirstIfPresent(stringEncoded: Data.self, forKeys: "extOptBytes", "ext_opt_bytes")
        ...
        self.ext_rep_int32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "extRepInt32", "ext_rep_int32")
        self.ext_rep_uint32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "extRepUint32", "ext_rep_uint32")
        self.ext_rep_sint32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "extRepSint32", "ext_rep_sint32")
        self.ext_rep_fixed32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "extRepFixed32", "ext_rep_fixed32")
        self.ext_rep_sfixed32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "extRepSfixed32", "ext_rep_sfixed32")
        self.ext_rep_int64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "extRepInt64", "ext_rep_int64")
        self.ext_rep_uint64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "extRepUint64", "ext_rep_uint64")
        self.ext_rep_sint64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "extRepSint64", "ext_rep_sint64")
        self.ext_rep_fixed64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "extRepFixed64", "ext_rep_fixed64")
        self.ext_rep_sfixed64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "extRepSfixed64", "ext_rep_sfixed64")
        self.ext_rep_bool = try container.decodeFirstProtoArray(Bool.self, forKeys: "extRepBool", "ext_rep_bool")
        self.ext_rep_float = try container.decodeFirstProtoArray(Float.self, forKeys: "extRepFloat", "ext_rep_float")
        self.ext_rep_double = try container.decodeFirstProtoArray(Double.self, forKeys: "extRepDouble", "ext_rep_double")
        self.ext_rep_string = try container.decodeFirstProtoArray(String.self, forKeys: "extRepString", "ext_rep_string")
        self.ext_rep_bytes = try container.decodeFirstProtoArray(stringEncoded: Data.self, forKeys: "extRepBytes", "ext_rep_bytes")
        self.ext_rep_nested_enum = try container.decodeFirstProtoArray(AllTypes.NestedEnum.self, forKeys: "extRepNestedEnum", "ext_rep_nested_enum")
        self.ext_rep_nested_message = try container.decodeFirstProtoArray(AllTypes.NestedMessage.self, forKeys: "extRepNestedMessage", "ext_rep_nested_message")
        self.ext_pack_int32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "extPackInt32", "ext_pack_int32")
        self.ext_pack_uint32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "extPackUint32", "ext_pack_uint32")
        self.ext_pack_sint32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "extPackSint32", "ext_pack_sint32")
        self.ext_pack_fixed32 = try container.decodeFirstProtoArray(UInt32.self, forKeys: "extPackFixed32", "ext_pack_fixed32")
        self.ext_pack_sfixed32 = try container.decodeFirstProtoArray(Int32.self, forKeys: "extPackSfixed32", "ext_pack_sfixed32")
        self.ext_pack_int64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "extPackInt64", "ext_pack_int64")
        self.ext_pack_uint64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "extPackUint64", "ext_pack_uint64")
        self.ext_pack_sint64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "extPackSint64", "ext_pack_sint64")
        self.ext_pack_fixed64 = try container.decodeFirstProtoArray(stringEncoded: UInt64.self, forKeys: "extPackFixed64", "ext_pack_fixed64")
        self.ext_pack_sfixed64 = try container.decodeFirstProtoArray(stringEncoded: Int64.self, forKeys: "extPackSfixed64", "ext_pack_sfixed64")
        self.ext_pack_bool = try container.decodeFirstProtoArray(Bool.self, forKeys: "extPackBool", "ext_pack_bool")
        self.ext_pack_float = try container.decodeFirstProtoArray(Float.self, forKeys: "extPackFloat", "ext_pack_float")
        self.ext_pack_double = try container.decodeFirstProtoArray(Double.self, forKeys: "extPackDouble", "ext_pack_double")
        self.ext_pack_nested_enum = try container.decodeFirstProtoArray(AllTypes.NestedEnum.self, forKeys: "extPackNestedEnum", "ext_pack_nested_enum")
    }
