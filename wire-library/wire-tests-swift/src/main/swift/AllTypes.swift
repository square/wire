    ...
    public init(from reader: ProtoReader) throws {
        ...
        let unknownFields = try reader.forEachTag { tag in
            switch tag {
                ...
                case 203: try reader.decode(into: &rep_sint32)
                case 204: try reader.decode(into: &rep_fixed32)
                ...
                case 208: try reader.decode(into: &rep_sint64)
                case 209: try reader.decode(into: &rep_fixed64)
                ...
                case 303: try reader.decode(into: &pack_sint32)
                case 304: try reader.decode(into: &pack_fixed32)
                ...
                case 308: try reader.decode(into: &pack_sint64)
                case 309: try reader.decode(into: &pack_fixed64)
