...
public class FieldDescriptorProto(
  ...
  public val proto3_optional: Boolean? = null,
  ...
  public override fun equals(other: Any?): Boolean {
    ...
    if (proto3_optional != other.proto3_optional) return false
    return true
  }
  ...
  public override fun hashCode(): Int {
    ...
    if (result == 0) {
      ...
      result = result * 37 + proto3_optional.hashCode()
  ...
  public override fun toString(): String {
    ...
    if (proto3_optional != null) result += """proto3_optional=$proto3_optional"""
  ...
  public fun copy(
    ...
    proto3_optional: Boolean? = this.proto3_optional,
    unknownFields: ByteString = this.unknownFields
  ): FieldDescriptorProto = FieldDescriptorProto(name, number, label, type, type_name, extendee,
      default_value, oneof_index, json_name, options, proto3_optional, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<FieldDescriptorProto> = object :
      ...
      public override fun encodedSize(value: FieldDescriptorProto): Int {
        ...
        size += ProtoAdapter.BOOL.encodedSizeWithTag(17, value.proto3_optional)
        return size
      }
      ...
      public override fun encode(writer: ProtoWriter, value: FieldDescriptorProto): Unit {
        ...
        ProtoAdapter.BOOL.encodeWithTag(writer, 17, value.proto3_optional)
      ...
      public override fun decode(reader: ProtoReader): FieldDescriptorProto {
        ...
        var proto3_optional: Boolean? = null
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            17 -> proto3_optional = ProtoAdapter.BOOL.decode(reader)
