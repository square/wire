...
public class Recursive(
...
) : Message<Recursive, Recursive.Builder>(ADAPTER, unknownFields) {
  ...
  public class Builder : Message.Builder<Recursive, Builder>() {
    @JvmField
    public var value_: Int? = null

    @JvmField
    public var recursive: Recursive? = null

    public fun value_(value_: Int?): Builder {
      this.value_ = value_
      return this
    }

    public fun recursive(recursive: Recursive?): Builder {
      this.recursive = recursive
      return this
    }

    public override fun build(): Recursive = Recursive(
      value_ = value_,
      recursive = recursive,
