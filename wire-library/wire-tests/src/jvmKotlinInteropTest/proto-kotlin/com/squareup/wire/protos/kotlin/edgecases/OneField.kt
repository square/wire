...
public class OneField(
...
) : Message<OneField, OneField.Builder>(ADAPTER, unknownFields) {
  ...
  public class Builder : Message.Builder<OneField, Builder>() {
    @JvmField
    ...
    public override fun build(): OneField = OneField(
      opt_int32 = opt_int32,
