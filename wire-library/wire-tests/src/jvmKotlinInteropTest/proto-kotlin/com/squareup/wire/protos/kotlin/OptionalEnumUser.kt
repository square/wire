...
public class OptionalEnumUser(
  ...
  public override fun newBuilder(): Builder {
    val builder = Builder()
    builder.optional_enum = optional_enum
  ...
  public class Builder : Message.Builder<OptionalEnumUser, Builder>() {
    @JvmField
    public var optional_enum: OptionalEnum? = null

    public fun optional_enum(optional_enum: OptionalEnum?): Builder {
      this.optional_enum = optional_enum
      return this
    }

    public override fun build(): OptionalEnumUser = OptionalEnumUser(
