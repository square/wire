...
public class OneBytesField(
...
) : Message<OneBytesField, OneBytesField.Builder>(ADAPTER, unknownFields) {
  ...
  public class Builder : Message.Builder<OneBytesField, Builder>() {
    @JvmField
    ...
    public override fun build(): OneBytesField = OneBytesField(
      opt_bytes = opt_bytes,
