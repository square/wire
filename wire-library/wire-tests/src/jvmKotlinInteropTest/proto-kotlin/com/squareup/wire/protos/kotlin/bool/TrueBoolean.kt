...
public class TrueBoolean(
...
) : Message<TrueBoolean, TrueBoolean.Builder>(ADAPTER, unknownFields) {
  public override fun newBuilder(): Builder {
    val builder = Builder()
    builder.isTrue = isTrue
  ...
  public class Builder : Message.Builder<TrueBoolean, Builder>() {
    @JvmField
    public var isTrue: Boolean? = null

    public fun isTrue(isTrue: Boolean?): Builder {
      this.isTrue = isTrue
      return this
    }

    public override fun build(): TrueBoolean = TrueBoolean(
      isTrue = isTrue,
