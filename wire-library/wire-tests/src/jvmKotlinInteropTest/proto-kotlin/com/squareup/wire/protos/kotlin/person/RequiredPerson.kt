...
public class RequiredPerson(
...
) : Message<RequiredPerson, RequiredPerson.Builder>(ADAPTER, unknownFields) {
  ...
  public class Builder : Message.Builder<RequiredPerson, Builder>() {
    @JvmField
    public var person: Person? = null

    public fun person(person: Person?): Builder {
      this.person = person
      return this
    }

    public override fun build(): RequiredPerson = RequiredPerson(
