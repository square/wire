  ...
  override fun newHandler(
    ...
    return object : SchemaHandler {
      ...
      private fun write(
        ...
        logger.artifactHandled(
          modulePath, "${javaFile.packageName}.${javaFile.typeSpec.name}", "Java"
        )
        try {
  ...
  override fun newHandler(
    ...
    return object : SchemaHandler {
      ...
      private fun write(
        ...
        logger.artifactHandled(
          path, "${kotlinFile.packageName}.${(kotlinFile.members.first() as TypeSpec).name}",
          "Kotlin"
        )
        try {
          fs.createDirectories(filePath.parent!!)
...
private class ClassNameCustomHandlerBeta(
  ...
  override fun newHandler(
    ...
    profileLoader: ProfileLoader,
    errorCollector: ErrorCollector,
  ): SchemaHandler = delegate.newHandler(
    schema, fs, outDirectory, logger, profileLoader, errorCollector
  )
}
