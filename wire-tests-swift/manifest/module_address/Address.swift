...
// Source: squareup.protos.kotlin.swift_modules.address.Address in swift_module_address.proto
import Wire

/**
 * This message exists in both this file and swift_module_location.proto in order to verify
...
extension Address : ProtoMessage {
    ...
    public static func protoMessageTypeURL() -> String {
        return "type.googleapis.com/squareup.protos.kotlin.swift_modules.address.Address"
    }
