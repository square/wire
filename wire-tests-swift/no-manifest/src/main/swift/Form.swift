...
extension Form : Proto2Codable {
    ...
    public init(from protoReader: ProtoReader) throws {
        ...
        var button_elementProtoData: Foundation.Data? = nil
        var local_image_elementProtoData: Foundation.Data? = nil
        var remote_image_elementProtoData: Foundation.Data? = nil
        var money_elementProtoData: Foundation.Data? = nil
        var spacer_elementProtoData: Foundation.Data? = nil
        var text_elementProtoData: Foundation.Data? = nil
        var customized_card_elementProtoData: Foundation.Data? = nil
        var address_elementProtoData: Foundation.Data? = nil
        var text_input_elementProtoData: Foundation.Data? = nil
        var option_picker_elementProtoData: Foundation.Data? = nil
        var detail_row_elementProtoData: Foundation.Data? = nil
        var currency_conversion_flags_elementProtoData: Foundation.Data? = nil
        var decision: Decision? = nil

        let token = try protoReader.beginMessage()
        while let tag = try protoReader.nextTag(token: token) {
            switch tag {
            case 1: if choiceProtoTag != 1 { button_elementProtoData = nil }; choiceProtoTag = 1; try protoReader.decodeMessage(into: &button_elementProtoData)
            case 2: if choiceProtoTag != 2 { local_image_elementProtoData = nil }; choiceProtoTag = 2; try protoReader.decodeMessage(into: &local_image_elementProtoData)
            case 3: if choiceProtoTag != 3 { remote_image_elementProtoData = nil }; choiceProtoTag = 3; try protoReader.decodeMessage(into: &remote_image_elementProtoData)
            case 4: if choiceProtoTag != 4 { money_elementProtoData = nil }; choiceProtoTag = 4; try protoReader.decodeMessage(into: &money_elementProtoData)
            case 5: if choiceProtoTag != 5 { spacer_elementProtoData = nil }; choiceProtoTag = 5; try protoReader.decodeMessage(into: &spacer_elementProtoData)
            case 6: if choiceProtoTag != 6 { text_elementProtoData = nil }; choiceProtoTag = 6; try protoReader.decodeMessage(into: &text_elementProtoData)
            case 7: if choiceProtoTag != 7 { customized_card_elementProtoData = nil }; choiceProtoTag = 7; try protoReader.decodeMessage(into: &customized_card_elementProtoData)
            case 8: if choiceProtoTag != 8 { address_elementProtoData = nil }; choiceProtoTag = 8; try protoReader.decodeMessage(into: &address_elementProtoData)
            case 9: if choiceProtoTag != 9 { text_input_elementProtoData = nil }; choiceProtoTag = 9; try protoReader.decodeMessage(into: &text_input_elementProtoData)
            case 10: if choiceProtoTag != 10 { option_picker_elementProtoData = nil }; choiceProtoTag = 10; try protoReader.decodeMessage(into: &option_picker_elementProtoData)
            case 11: if choiceProtoTag != 11 { detail_row_elementProtoData = nil }; choiceProtoTag = 11; try protoReader.decodeMessage(into: &detail_row_elementProtoData)
            case 12: if choiceProtoTag != 12 { currency_conversion_flags_elementProtoData = nil }; choiceProtoTag = 12; try protoReader.decodeMessage(into: &currency_conversion_flags_elementProtoData)
        ...
        if choiceProtoTag == 1, let button_elementProtoData {
            choice = .button_element(try protoReader.decodeMergedMessage(Form.ButtonElement.self, from: button_elementProtoData))
        }
        if choiceProtoTag == 2, let local_image_elementProtoData {
            choice = .local_image_element(try protoReader.decodeMergedMessage(Form.LocalImageElement.self, from: local_image_elementProtoData))
        }
        if choiceProtoTag == 3, let remote_image_elementProtoData {
            choice = .remote_image_element(try protoReader.decodeMergedMessage(Form.RemoteImageElement.self, from: remote_image_elementProtoData))
        }
        if choiceProtoTag == 4, let money_elementProtoData {
            choice = .money_element(try protoReader.decodeMergedMessage(Form.MoneyElement.self, from: money_elementProtoData))
        }
        if choiceProtoTag == 5, let spacer_elementProtoData {
            choice = .spacer_element(try protoReader.decodeMergedMessage(Form.SpacerElement.self, from: spacer_elementProtoData))
        }
        if choiceProtoTag == 6, let text_elementProtoData {
            choice = .text_element(try protoReader.decodeMergedMessage(Form.TextElement.self, from: text_elementProtoData))
        }
        if choiceProtoTag == 7, let customized_card_elementProtoData {
            choice = .customized_card_element(try protoReader.decodeMergedMessage(Form.CustomizedCardElement.self, from: customized_card_elementProtoData))
        }
        if choiceProtoTag == 8, let address_elementProtoData {
            choice = .address_element(try protoReader.decodeMergedMessage(Form.AddressElement.self, from: address_elementProtoData))
        }
        if choiceProtoTag == 9, let text_input_elementProtoData {
            choice = .text_input_element(try protoReader.decodeMergedMessage(Form.TextInputElement.self, from: text_input_elementProtoData))
        }
        if choiceProtoTag == 10, let option_picker_elementProtoData {
            choice = .option_picker_element(try protoReader.decodeMergedMessage(Form.OptionPickerElement.self, from: option_picker_elementProtoData))
        }
        if choiceProtoTag == 11, let detail_row_elementProtoData {
            choice = .detail_row_element(try protoReader.decodeMergedMessage(Form.DetailRowElement.self, from: detail_row_elementProtoData))
        }
        if choiceProtoTag == 12, let currency_conversion_flags_elementProtoData {
            choice = .currency_conversion_flags_element(try protoReader.decodeMergedMessage(Form.CurrencyConversionFlagsElement.self, from: currency_conversion_flags_elementProtoData))
        }
