...
extension FooBar : Proto2Codable {
    ...
    public init(from protoReader: ProtoReader) throws {
        ...
        var nested: [FooBar] = []
        var bazProtoData: Foundation.Data? = nil
        ...
        while let tag = try protoReader.nextTag(token: token) {
            ...
            case 3: try protoReader.decodeMessage(into: &bazProtoData)
        ...
        if let bazProtoData {
            baz = try protoReader.decodeMergedMessage(FooBar.Nested.self, from: bazProtoData)
        }
