...
class ReverseProtoWriterTest {
  ...
  private fun assertUtf8(string: String, expectedHex: String) {
    ...
    assertThat(buffer.readByteString().hex()).isEqualTo<String>(expectedHex)
