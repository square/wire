...
actual abstract class ProtoAdapter<E> actual constructor(
  ...
  actual companion object {
    ...
    @JvmField actual val INT64_PRIMITIVE_ARRAY: ProtoAdapter<LongArray> = LongArrayProtoAdapter(INT64)
    ...
    @JvmField actual val FLOAT_PRIMITIVE_ARRAY: ProtoAdapter<FloatArray> = FloatArrayProtoAdapter(FLOAT)
