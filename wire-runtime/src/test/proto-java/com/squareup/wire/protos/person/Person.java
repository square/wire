...
public final class Person extends Message<Person, Person.Builder> {
  ...
  public enum PhoneType implements WireEnum {
    ...
    private static final class ProtoAdapter_PhoneType extends ProtoAdapter<PhoneType> {
      ProtoAdapter_PhoneType() {
        super(FieldEncoding.VARINT, PhoneType.class);
      }
      ...
      public PhoneType decode(ProtoReader reader) {
        ...
        PhoneType constant = PhoneType.fromValue(value);
        if (constant != null) return constant;
        throw new ProtoAdapter.EnumConstantNotFoundException(value, PhoneType.class);
      }
    }
  }
