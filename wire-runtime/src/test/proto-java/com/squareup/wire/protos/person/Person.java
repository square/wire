...
public final class Person extends Message<Person, Person.Builder> {
  ...
  @WireField(
      tag = 5,
      adapter = "com.squareup.wire.protos.person.Person$Address#ADAPTER"
  )
  public final Address address;

  public Person(String name, Integer id, String email, List<PhoneNumber> phone, Address address) {
    this(name, id, email, phone, address, ByteString.EMPTY);
  }
  ...
  public static final class Builder extends Message.Builder<Person, Builder> {
    ...
    public Person build() {
      ...
      return new Person(name, id, email, phone, address, super.buildUnknownFields());
    }
  }
   ...
   */
  public static final class Address extends Message<Address, Address.Builder> {
    ...
    public Address(String zipCode, String address) {
      this(zipCode, address, ByteString.EMPTY);
    }

    public Address(String zipCode, String address, ByteString unknownFields) {
      super(ADAPTER, unknownFields);
    ...
    public int hashCode() {
      ...
      if (result == 0) {
        result = unknownFields().hashCode();
        result = result * 37 + zipCode.hashCode();
    ...
    public String toString() {
      ...
      return builder.replace(0, 2, "Address{").append('}').toString();
    }
    ...
    public static final class Builder extends Message.Builder<Address, Builder> {
      ...
      public Address build() {
        if (zipCode == null
            || address == null) {
          throw Internal.missingRequiredFields(zipCode, "zipCode",
              address, "address");
        }
        return new Address(zipCode, address, super.buildUnknownFields());
      }
    }
    ...
    private static final class ProtoAdapter_Address extends ProtoAdapter<Address> {
      ...
      public int encodedSize(Address value) {
        return ProtoAdapter.STRING.encodedSizeWithTag(1, value.zipCode)
      ...
      public void encode(ProtoWriter writer, Address value) throws IOException {
        ProtoAdapter.STRING.encodeWithTag(writer, 1, value.zipCode);
      ...
      public Address decode(ProtoReader reader) throws IOException {
        ...
        for (int tag; (tag = reader.nextTag()) != -1;) {
          switch (tag) {
            case 1: builder.zipCode(ProtoAdapter.STRING.decode(reader)); break;
            case 2: builder.address(ProtoAdapter.STRING.decode(reader)); break;
            default: {
              FieldEncoding fieldEncoding = reader.peekFieldEncoding();
              Object value = fieldEncoding.rawProtoAdapter().decode(reader);
              builder.addUnknownField(tag, fieldEncoding, value);
  ...
  private static final class ProtoAdapter_Person extends ProtoAdapter<Person> {
    ...
    public int encodedSize(Person value) {
      return ProtoAdapter.STRING.encodedSizeWithTag(1, value.name)
          ...
          + Address.ADAPTER.encodedSizeWithTag(5, value.address)
          + value.unknownFields().size();
    }
    ...
    public void encode(ProtoWriter writer, Person value) throws IOException {
      ...
      Address.ADAPTER.encodeWithTag(writer, 5, value.address);
      writer.writeBytes(value.unknownFields());
    }
    ...
    public Person decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 5: builder.address(Address.ADAPTER.decode(reader)); break;
          default: {
            FieldEncoding fieldEncoding = reader.peekFieldEncoding();
            Object value = fieldEncoding.rawProtoAdapter().decode(reader);
            builder.addUnknownField(tag, fieldEncoding, value);
    ...
    public Person redact(Person value) {
      ...
      if (builder.address != null) builder.address = Address.ADAPTER.redact(builder.address);
      builder.clearUnknownFields();
      return builder.build();
    }
  }
