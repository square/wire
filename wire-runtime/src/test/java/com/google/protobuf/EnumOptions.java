...
public final class EnumOptions extends ExtendableMessage<EnumOptions> {
  ...
  public static final TypeAdapter<EnumOptions> ADAPTER = new TypeAdapter.MessageAdapter<EnumOptions>() {
    @Override
    public EnumOptions read(ProtoReader reader) throws IOException {
      return EnumOptions.read(reader);
    }
  };
  ...
  public static EnumOptions read(ProtoReader reader) throws IOException {
  ...
  public static final class Builder extends ExtendableMessage.ExtendableBuilder<EnumOptions, Builder> {
    ...
    public Builder() {
      super(EnumOptions.class, Builder.class);
    }

    public Builder(EnumOptions message) {
      super(EnumOptions.class, Builder.class, message);
