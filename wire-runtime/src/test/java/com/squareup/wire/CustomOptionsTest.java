...
public class CustomOptionsTest {
  ...
  public void testMessageOptions() {
    ...
    assertThat(option_five.getExtension(Ext_custom_options.ext)).isEqualTo(BAZ);
    assertThat(option_five.getExtension(Ext_custom_options.rep)).containsExactly(FOO, BAZ);
    ...
    assertThat(FooBar.FooBarBazEnum.ENUM_OPTIONS.getExtension(Ext_custom_options.enum_option))
        .isTrue();
  }
}
