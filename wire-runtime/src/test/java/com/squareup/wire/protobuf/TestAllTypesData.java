...
public class TestAllTypesData {
  ...
  public static final String expectedToString =
      ...
      "opt_float=122.0,opt_double=123.0,opt_string=124,opt_bytes={125,225},opt_nested_enum=A," +
      "opt_nested_message=NestedMessage{a=999}," +
      ...
      "req_double=123.0,req_string=124,req_bytes={125,225},req_nested_enum=A," +
      ...
      "rep_string=[124, 124],rep_bytes=[{125,225}, {125,225}],rep_nested_enum=[A, A]," +
      "rep_nested_message=[NestedMessage{a=999}, NestedMessage{a=999}]," +
  ...
  public static final int[] nonPacked = {
      // optional
      ...
      0xe8, 0x12, // tag = 301, type = 0
      0x6f, // value = 111
      0xe8, 0x12, // tag = 301, type = 0
      0x6f, // value = 111

      0xf0, 0x12, // tag = 302, type = 0
      0x70, // value = 112
      0xf0, 0x12, // tag = 302, type = 0
      0x70, // value = 112

      0xf8, 0x12, // tag = 303, type = 0
      0xe2, 0x01, // value = 226 (=113 zig-zag)
      0xf8, 0x12, // tag = 303, type = -
      0xe2, 0x01, // value = 226 (=113 zig-zag)

      0x80, 0x13, // tag = 304, type = 0
      0x72, 0x00, 0x00, 0x00, // value = 114 (fixed32)
      0x80, 0x13, // tag = 304, type = 0
      0x72, 0x00, 0x00, 0x00, // value = 114 (fixed32)

      0x88, 0x13, // tag = 305, type = 0
      0x73, 0x00, 0x00, 0x00, // value = 115 (sfixed32)
      0x88, 0x13, // tag = 305, type = 0
      0x73, 0x00, 0x00, 0x00, // value = 115 (sfixed32)

      0x90, 0x13, // tag = 306, type = 0
      0x74, // value = 116
      0x90, 0x13, // tag = 306, type = 0
      0x74, // value = 116

      0x98, 0x13, // tag = 307, type = 0
      0x75, // value = 117
      0x98, 0x13, // tag = 307, type = 0
      0x75, // value = 117

      0xa0, 0x13, // tag = 308, type = 0
      0xec, 0x01, // value = 236 (=118 zigzag)
      0xa0, 0x13, // tag = 308, type = 0
      0xec, 0x01, // value = 236 (=118 zigzag)

      0xa8, 0x13, // tag = 309, type = 0
      0x77, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // value = 119
      0xa8, 0x13, // tag = 309, type = 0
      0x77, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // value = 119

      0xb0, 0x13, // tag = 310, type = 0
      0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // value = 120
      0xb0, 0x13, // tag = 310, type = 0
      0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // value = 120

      0xb8, 0x13, // tag = 311, type = 0
      0x01, // value = 1 (true)
      0xb8, 0x13, // tag = 311, type = 0
      0x01, // value = 1 (true)

      0xc0, 0x13, // tag = 312, type = 0
      0x00, 0x00, 0xf4, 0x42, // value = 122.0F
      0xc0, 0x13, // tag = 312, type = 0
      0x00, 0x00, 0xf4, 0x42, // value = 122.0F

      0xc8, 0x13, // tag = 313, type = 0
      0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x5e, 0x40, // value = 123.0
      0xc8, 0x13, // tag = 313, type = 0
      0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x5e, 0x40, // value = 123.0
