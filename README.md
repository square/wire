...
Here's the generated code for the `Dinosaur` message defined above:

```java
// Code generated by Wire protocol buffer compiler, do not edit.
// Source file: sample/src/main/proto/squareup/dinosaurs/dinosaur.proto at 9:1
...
public final class Dinosaur extends Message<Dinosaur> {
  ...
  public Dinosaur(String name, List<String> picture_urls, Period period) {
    this(name, picture_urls, period, TagMap.EMPTY);
  }

  public Dinosaur(String name, List<String> picture_urls, Period period, TagMap tagMap) {
    super(tagMap);
    this.name = name;
    this.picture_urls = immutableCopyOf(picture_urls);
    this.period = period;
  }
  ...
  public static final class Builder extends com.squareup.wire.Message.Builder<Dinosaur, Builder> {
    ...
    public List<String> picture_urls = Collections.emptyList();
    ...
    public Builder(Dinosaur message) {
      super(message);
      if (message == null) return;
      this.name = message.name;
      this.picture_urls = copyOf(message.picture_urls);
    ...
    public Builder picture_urls(List<String> picture_urls) {
      this.picture_urls = canonicalizeList(picture_urls);
      return this;
    }
    ...
    public Dinosaur build() {
      return new Dinosaur(name, picture_urls, period, buildTagMap());
    }
  }
}
```
