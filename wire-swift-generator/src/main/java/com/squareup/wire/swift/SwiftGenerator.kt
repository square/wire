...
class SwiftGenerator private constructor(
  ...
  companion object {
    ...
    private val BUILT_IN_TYPES: Map<out ProtoType, DeclaredTypeName> = mapOf(
      ...
      ProtoType.DOUBLE_VALUE to DOUBLE,
      ProtoType.FLOAT_VALUE to FLOAT,
      ProtoType.INT64_VALUE to INT64,
      ProtoType.UINT64_VALUE to UINT64,
      ProtoType.INT32_VALUE to INT32,
      ProtoType.UINT32_VALUE to UINT32,
      ProtoType.BOOL_VALUE to BOOL,
      ProtoType.STRING_VALUE to STRING,
      ProtoType.BYTES_VALUE to FOUNDATION_DATA,
