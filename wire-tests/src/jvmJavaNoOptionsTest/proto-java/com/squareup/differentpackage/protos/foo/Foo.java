...
public final class Foo extends Message<Foo, Foo.Builder> {
  ...
  private static final class ProtoAdapter_Foo extends ProtoAdapter<Foo> {
    public ProtoAdapter_Foo() {
      super(FieldEncoding.LENGTH_DELIMITED, Foo.class, "type.googleapis.com/squareup.differentpackage.foo.Foo", Syntax.PROTO_2.INSTANCE, null, "differentpackage/foo.proto");
    }
