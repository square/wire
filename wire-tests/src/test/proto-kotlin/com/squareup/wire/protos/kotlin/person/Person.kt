...
data class Person(
    ...
    @field:WireField(tag = 3, adapter = "com.squareup.wire.ProtoAdapter.STRING") val email: String?
            = null,
    @field:WireField(tag = 4, adapter = "Person.PhoneNumber.ADAPTER") val phone: List<PhoneNumber> =
            emptyList(),
    ...
    companion object {
        ...
        val ADAPTER: ProtoAdapter<Person> = object : ProtoAdapter<Person>(
            ...
            override fun encodedSize(value: Person): Int = 
                ...
                Person.PhoneNumber.ADAPTER.asRepeated().encodedSizeWithTag(4, value.phone) +
            ...
            override fun encode(writer: ProtoWriter, value: Person) {
                ...
                Person.PhoneNumber.ADAPTER.asRepeated().encodeWithTag(writer, 4, value.phone)
            ...
            override fun decode(reader: ProtoReader): Person {
                ...
                val unknownFields = reader.forEachTag { tag ->
                    when (tag) {
                        ...
                        4 -> phone.add(Person.PhoneNumber.ADAPTER.decode(reader))
    ...
    data class PhoneNumber(
        @field:WireField(tag = 1, adapter = "com.squareup.wire.ProtoAdapter.STRING") val number:
                String,
        @field:WireField(tag = 2, adapter = "Person.PhoneType.ADAPTER") val type: PhoneType? =
                PhoneType.HOME,
        val unknownFields: ByteString = ByteString.EMPTY
        ...
        companion object {
            ...
            val ADAPTER: ProtoAdapter<PhoneNumber> = object : ProtoAdapter<PhoneNumber>(
                ...
                override fun encodedSize(value: PhoneNumber): Int = 
                    ...
                    Person.PhoneType.ADAPTER.encodedSizeWithTag(2, value.type) +
                    value.unknownFields.size

                override fun encode(writer: ProtoWriter, value: PhoneNumber) {
                    ProtoAdapter.STRING.encodeWithTag(writer, 1, value.number)
                    Person.PhoneType.ADAPTER.encodeWithTag(writer, 2, value.type)
                    writer.writeBytes(value.unknownFields)
                }
                ...
                override fun decode(reader: ProtoReader): PhoneNumber {
                    ...
                    val unknownFields = reader.forEachTag { tag ->
                        when (tag) {
                            ...
                            2 -> type = Person.PhoneType.ADAPTER.decode(reader)
                            else -> TagHandler.UNKNOWN_TAG
                        }
                    }
                    return PhoneNumber(
