  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<MessageUsingMultipleEnums> = object :
      ...
      override fun encodedSize(value: MessageUsingMultipleEnums): Int = 
        com.squareup.wire.protos.kotlin.MessageWithStatus$Status.ADAPTER.encodedSizeWithTag(1,
            value.a) +
        com.squareup.wire.protos.kotlin.OtherMessageWithStatus$Status.ADAPTER.encodedSizeWithTag(2,
            value.b) +
        value.unknownFields.size

      override fun encode(writer: ProtoWriter, value: MessageUsingMultipleEnums) {
        com.squareup.wire.protos.kotlin.MessageWithStatus$Status.ADAPTER.encodeWithTag(writer, 1,
            value.a)
        com.squareup.wire.protos.kotlin.OtherMessageWithStatus$Status.ADAPTER.encodeWithTag(writer,
            2, value.b)
      ...
      override fun decode(reader: ProtoReader): MessageUsingMultipleEnums {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            1 -> a = com.squareup.wire.protos.kotlin.MessageWithStatus$Status.ADAPTER.decode(reader)
            2 -> b =
                com.squareup.wire.protos.kotlin.OtherMessageWithStatus$Status.ADAPTER.decode(reader)
