  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<Mappy> = object : ProtoAdapter<Mappy>(
      ...
      private val thingsAdapter: ProtoAdapter<Map<String, Thing>> =
          ProtoAdapter.newMapAdapter(ProtoAdapter.STRING,
          com.squareup.wire.protos.kotlin.map.Thing.ADAPTER)
      ...
      override fun redact(value: Mappy): Mappy = value.copy(
        things = value.things.redactElements(com.squareup.wire.protos.kotlin.map.Thing.ADAPTER),
