...
public final class FileDescriptorProto extends Message<FileDescriptorProto, FileDescriptorProto.Builder> {
  ...
  public Builder newBuilder() {
    ...
    builder.dependency = Internal.copyOf(dependency);
    builder.public_dependency = Internal.copyOf(public_dependency);
    builder.weak_dependency = Internal.copyOf(weak_dependency);
    builder.message_type = Internal.copyOf(message_type);
    builder.enum_type = Internal.copyOf(enum_type);
    builder.service = Internal.copyOf(service);
  ...
  private static final class ProtoAdapter_FileDescriptorProto extends ProtoAdapter<FileDescriptorProto> {
    public ProtoAdapter_FileDescriptorProto() {
      super(FieldEncoding.LENGTH_DELIMITED, FileDescriptorProto.class, "type.googleapis.com/google.protobuf.FileDescriptorProto");
    }
