...
public final class AllTypes extends Message<AllTypes, AllTypes.Builder> {
  ...
  public String toString() {
    ...
    length += 13 + opt_uint32.toString().length();
    length += 13 + opt_sint32.toString().length();
    length += 14 + opt_fixed32.toString().length();
    length += 15 + opt_sfixed32.toString().length();
    length += 12 + opt_int64.toString().length();
    length += 13 + opt_uint64.toString().length();
    length += 13 + opt_sint64.toString().length();
    length += 14 + opt_fixed64.toString().length();
    length += 15 + opt_sfixed64.toString().length();
    length += 11 + opt_bool.toString().length();
    length += 12 + opt_float.toString().length();
    length += 13 + opt_double.toString().length();
    length += 13 + opt_string.length();
    length += 12 + opt_bytes.toString().length();
    length += 18 + opt_nested_enum.toString().length();
    length += 21 + opt_nested_message.toString().length();
    length += 12 + req_int32.toString().length();
    length += 13 + req_uint32.toString().length();
    length += 13 + req_sint32.toString().length();
    length += 14 + req_fixed32.toString().length();
    length += 15 + req_sfixed32.toString().length();
    length += 12 + req_int64.toString().length();
    length += 13 + req_uint64.toString().length();
    length += 13 + req_sint64.toString().length();
    length += 14 + req_fixed64.toString().length();
    length += 15 + req_sfixed64.toString().length();
    length += 11 + req_bool.toString().length();
    length += 12 + req_float.toString().length();
    length += 13 + req_double.toString().length();
    length += 13 + req_string.length();
    length += 12 + req_bytes.toString().length();
    length += 18 + req_nested_enum.toString().length();
    length += 21 + req_nested_message.toString().length();
    if (!rep_int32.isEmpty()) length += 12 + rep_int32.toString().length();
    if (!rep_uint32.isEmpty()) length += 13 + rep_uint32.toString().length();
    if (!rep_sint32.isEmpty()) length += 13 + rep_sint32.toString().length();
    if (!rep_fixed32.isEmpty()) length += 14 + rep_fixed32.toString().length();
    if (!rep_sfixed32.isEmpty()) length += 15 + rep_sfixed32.toString().length();
    if (!rep_int64.isEmpty()) length += 12 + rep_int64.toString().length();
    if (!rep_uint64.isEmpty()) length += 13 + rep_uint64.toString().length();
    if (!rep_sint64.isEmpty()) length += 13 + rep_sint64.toString().length();
    if (!rep_fixed64.isEmpty()) length += 14 + rep_fixed64.toString().length();
    if (!rep_sfixed64.isEmpty()) length += 15 + rep_sfixed64.toString().length();
    if (!rep_bool.isEmpty()) length += 11 + rep_bool.toString().length();
    if (!rep_float.isEmpty()) length += 12 + rep_float.toString().length();
    if (!rep_double.isEmpty()) length += 13 + rep_double.toString().length();
    if (!rep_string.isEmpty()) length += 13 + rep_string.toString().length();
    if (!rep_bytes.isEmpty()) length += 12 + rep_bytes.toString().length();
    if (!rep_nested_enum.isEmpty()) length += 18 + rep_nested_enum.toString().length();
    if (!rep_nested_message.isEmpty()) length += 21 + rep_nested_message.toString().length();
    if (!pack_int32.isEmpty()) length += 13 + pack_int32.toString().length();
    if (!pack_uint32.isEmpty()) length += 14 + pack_uint32.toString().length();
    if (!pack_sint32.isEmpty()) length += 14 + pack_sint32.toString().length();
    if (!pack_fixed32.isEmpty()) length += 15 + pack_fixed32.toString().length();
    if (!pack_sfixed32.isEmpty()) length += 16 + pack_sfixed32.toString().length();
    if (!pack_int64.isEmpty()) length += 13 + pack_int64.toString().length();
    if (!pack_uint64.isEmpty()) length += 14 + pack_uint64.toString().length();
    if (!pack_sint64.isEmpty()) length += 14 + pack_sint64.toString().length();
    if (!pack_fixed64.isEmpty()) length += 15 + pack_fixed64.toString().length();
    if (!pack_sfixed64.isEmpty()) length += 16 + pack_sfixed64.toString().length();
    if (!pack_bool.isEmpty()) length += 12 + pack_bool.toString().length();
    if (!pack_float.isEmpty()) length += 13 + pack_float.toString().length();
    if (!pack_double.isEmpty()) length += 14 + pack_double.toString().length();
    if (!pack_nested_enum.isEmpty()) length += 19 + pack_nested_enum.toString().length();
    length += 16 + default_int32.toString().length();
    length += 17 + default_uint32.toString().length();
    length += 17 + default_sint32.toString().length();
    length += 18 + default_fixed32.toString().length();
    length += 19 + default_sfixed32.toString().length();
    length += 16 + default_int64.toString().length();
    length += 17 + default_uint64.toString().length();
    length += 17 + default_sint64.toString().length();
    length += 18 + default_fixed64.toString().length();
    length += 19 + default_sfixed64.toString().length();
    length += 15 + default_bool.toString().length();
    length += 16 + default_float.toString().length();
    length += 17 + default_double.toString().length();
    length += 17 + default_string.length();
    length += 16 + default_bytes.toString().length();
    length += 22 + default_nested_enum.toString().length();
    if (!map_int32_int32.isEmpty()) length += 18 + map_int32_int32.toString().length();
    if (!map_string_string.isEmpty()) length += 20 + map_string_string.toString().length();
    if (!map_string_message.isEmpty()) length += 21 + map_string_message.toString().length();
    if (!map_string_enum.isEmpty()) length += 18 + map_string_enum.toString().length();
    length += 16 + ext_opt_int32.toString().length();
    length += 17 + ext_opt_uint32.toString().length();
    length += 17 + ext_opt_sint32.toString().length();
    length += 18 + ext_opt_fixed32.toString().length();
    length += 19 + ext_opt_sfixed32.toString().length();
    length += 16 + ext_opt_int64.toString().length();
    length += 17 + ext_opt_uint64.toString().length();
    length += 17 + ext_opt_sint64.toString().length();
    length += 18 + ext_opt_fixed64.toString().length();
    length += 19 + ext_opt_sfixed64.toString().length();
    length += 15 + ext_opt_bool.toString().length();
    length += 16 + ext_opt_float.toString().length();
    length += 17 + ext_opt_double.toString().length();
    length += 17 + ext_opt_string.length();
    length += 16 + ext_opt_bytes.toString().length();
    length += 22 + ext_opt_nested_enum.toString().length();
    length += 25 + ext_opt_nested_message.toString().length();
    if (!ext_rep_int32.isEmpty()) length += 16 + ext_rep_int32.toString().length();
    if (!ext_rep_uint32.isEmpty()) length += 17 + ext_rep_uint32.toString().length();
    if (!ext_rep_sint32.isEmpty()) length += 17 + ext_rep_sint32.toString().length();
    if (!ext_rep_fixed32.isEmpty()) length += 18 + ext_rep_fixed32.toString().length();
    if (!ext_rep_sfixed32.isEmpty()) length += 19 + ext_rep_sfixed32.toString().length();
    if (!ext_rep_int64.isEmpty()) length += 16 + ext_rep_int64.toString().length();
    if (!ext_rep_uint64.isEmpty()) length += 17 + ext_rep_uint64.toString().length();
    if (!ext_rep_sint64.isEmpty()) length += 17 + ext_rep_sint64.toString().length();
    if (!ext_rep_fixed64.isEmpty()) length += 18 + ext_rep_fixed64.toString().length();
    if (!ext_rep_sfixed64.isEmpty()) length += 19 + ext_rep_sfixed64.toString().length();
    if (!ext_rep_bool.isEmpty()) length += 15 + ext_rep_bool.toString().length();
    if (!ext_rep_float.isEmpty()) length += 16 + ext_rep_float.toString().length();
    if (!ext_rep_double.isEmpty()) length += 17 + ext_rep_double.toString().length();
    if (!ext_rep_string.isEmpty()) length += 17 + ext_rep_string.toString().length();
    if (!ext_rep_bytes.isEmpty()) length += 16 + ext_rep_bytes.toString().length();
    if (!ext_rep_nested_enum.isEmpty()) length += 22 + ext_rep_nested_enum.toString().length();
    if (!ext_rep_nested_message.isEmpty()) length += 25 + ext_rep_nested_message.toString().length();
    if (!ext_pack_int32.isEmpty()) length += 17 + ext_pack_int32.toString().length();
    if (!ext_pack_uint32.isEmpty()) length += 18 + ext_pack_uint32.toString().length();
    if (!ext_pack_sint32.isEmpty()) length += 18 + ext_pack_sint32.toString().length();
    if (!ext_pack_fixed32.isEmpty()) length += 19 + ext_pack_fixed32.toString().length();
    if (!ext_pack_sfixed32.isEmpty()) length += 20 + ext_pack_sfixed32.toString().length();
    if (!ext_pack_int64.isEmpty()) length += 17 + ext_pack_int64.toString().length();
    if (!ext_pack_uint64.isEmpty()) length += 18 + ext_pack_uint64.toString().length();
    if (!ext_pack_sint64.isEmpty()) length += 18 + ext_pack_sint64.toString().length();
    if (!ext_pack_fixed64.isEmpty()) length += 19 + ext_pack_fixed64.toString().length();
    if (!ext_pack_sfixed64.isEmpty()) length += 20 + ext_pack_sfixed64.toString().length();
    if (!ext_pack_bool.isEmpty()) length += 16 + ext_pack_bool.toString().length();
    if (!ext_pack_float.isEmpty()) length += 17 + ext_pack_float.toString().length();
    if (!ext_pack_double.isEmpty()) length += 18 + ext_pack_double.toString().length();
    if (!ext_pack_nested_enum.isEmpty()) length += 23 + ext_pack_nested_enum.toString().length();
    if (!ext_map_int32_int32.isEmpty()) length += 22 + ext_map_int32_int32.toString().length();
    if (!ext_map_string_string.isEmpty()) length += 24 + ext_map_string_string.toString().length();
    if (!ext_map_string_message.isEmpty()) length += 25 + ext_map_string_message.toString().length();
    if (!ext_map_string_enum.isEmpty()) length += 22 + ext_map_string_enum.toString().length();
