...
public final class MapTypes extends Message<MapTypes, MapTypes.Builder> {
  public static final ProtoAdapter<MapTypes> ADAPTER = ProtoAdapter.newMessageAdapter(MapTypes.class, "type.googleapis.com/squareup.proto3.MapTypes", Syntax.PROTO_3.INSTANCE);
