...
class TestAllTypes {
  ...
  @Test fun testBuilder() {
    ...
    assertThat(builder.opt_string).isEqualTo<String?>("124")
    ...
    assertThat(builder.req_string).isEqualTo<String>("124")
    ...
    assertThat(builder.rep_string[0]).isEqualTo<String>("124")
    assertThat(builder.rep_string[1]).isEqualTo<String>("124")
  ...
  fun testToString() {
    val data = adapter.encode(allTypes)
    val parsed = adapter.decode(data)
    assertThat(parsed.toString()).isEqualTo<String>(TestAllTypesData.expectedToString)
  }
  ...
  @Test fun testDefaults() {
    ...
    assertThat(AllTypes.DEFAULT_DEFAULT_STRING).isEqualTo<String>(
      "çok\u0007\b\u000C\n\r\t\u000b\u0001\u0001\u0001\u000f\u000f~\u0001\u0001\u0011" +
        "\u0001\u0001\u0011güzel",
    )
  }
