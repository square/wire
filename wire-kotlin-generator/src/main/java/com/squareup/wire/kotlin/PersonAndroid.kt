...
data class PersonAndroid(
  ...
  override fun writeToParcel(dest: Parcel, p1: Int) = dest.writeByteArray(ADAPTER.encode(this))

  override fun describeContents() = 0

  object CREATOR : Parcelable.Creator<PersonAndroid> {
    override fun createFromParcel(input: Parcel) = ADAPTER.decode(input.createByteArray())

    override fun newArray(size: Int): Array<PersonAndroid?> = arrayOfNulls(size)
  }

  object ADAPTER : ProtoAdapter<PersonAndroid>(FieldEncoding.LENGTH_DELIMITED, PersonAndroid::class.java) {
    override fun encodedSize(value: PersonAndroid): Int = ProtoAdapter.STRING.encodedSizeWithTag(1, value.name) +
    ...
    override fun encode(writer: ProtoWriter, value: PersonAndroid) {
    ...
    override fun decode(reader: ProtoReader): PersonAndroid {
