...
public final class JavaPerson extends Message<JavaPerson, JavaPerson.Builder> {
  public static final ProtoAdapter<JavaPerson> ADAPTER = new ProtoAdapter_JavaPerson();
  ...
  public JavaPerson(String name, Integer id, String email, List<PhoneNumber> phone) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof JavaPerson)) return false;
    JavaPerson o = (JavaPerson) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "JavaPerson{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<JavaPerson, Builder> {
    public String name;
    ...
    public JavaPerson build() {
      ...
      return new JavaPerson(name, id, email, phone, super.buildUnknownFields());
    }
  }
  ...
  public static final class PhoneNumber extends Message<PhoneNumber, PhoneNumber.Builder> {
    ...
    @WireField(
        tag = 2,
        adapter = "com.squareup.wire.protos.person.JavaPerson$PhoneType#ADAPTER"
    )
  ...
  private static final class ProtoAdapter_JavaPerson extends ProtoAdapter<JavaPerson> {
    public ProtoAdapter_JavaPerson() {
      super(FieldEncoding.LENGTH_DELIMITED, JavaPerson.class);
    }

    @Override
    public int encodedSize(JavaPerson value) {
    ...
    @Override
    public void encode(ProtoWriter writer, JavaPerson value) throws IOException {
    ...
    @Override
    public JavaPerson decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      long token = reader.beginMessage();
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
    ...
    @Override
    public JavaPerson redact(JavaPerson value) {
      Builder builder = value.newBuilder();
