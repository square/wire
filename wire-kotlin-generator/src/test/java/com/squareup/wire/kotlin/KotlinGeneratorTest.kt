...
class KotlinGeneratorTest {
  ...
  fun redactedWithManyFieldsForProto3() {
    ...
    assertThat(code).contains(
      """
      |      override fun redact(`value`: BazillionFields): BazillionFields {
      |        var result = value.copy(
      |          field1 = value.field1?.let(FieldData.ADAPTER::redact),
      |          field2 = value.field2?.let(FieldData.ADAPTER::redact),
      |          field3 = value.field3?.let(FieldData.ADAPTER::redact),
      |          field4 = value.field4?.let(FieldData.ADAPTER::redact),
      |          field5 = value.field5?.let(FieldData.ADAPTER::redact),
      |          field6 = value.field6?.let(FieldData.ADAPTER::redact),
      |          field7 = value.field7?.let(FieldData.ADAPTER::redact),
      |          field8 = value.field8?.let(FieldData.ADAPTER::redact),
      |          field9 = value.field9?.let(FieldData.ADAPTER::redact),
      |          field10 = value.field10?.let(FieldData.ADAPTER::redact),
      |          field11 = value.field11?.let(FieldData.ADAPTER::redact),
      |          field12 = value.field12?.let(FieldData.ADAPTER::redact),
      |          field13 = value.field13?.let(FieldData.ADAPTER::redact),
      |          field14 = value.field14?.let(FieldData.ADAPTER::redact),
      |          field15 = value.field15?.let(FieldData.ADAPTER::redact),
      |          field16 = value.field16?.let(FieldData.ADAPTER::redact),
      |          field17 = value.field17?.let(FieldData.ADAPTER::redact),
      |          field18 = value.field18?.let(FieldData.ADAPTER::redact),
      |          field19 = value.field19?.let(FieldData.ADAPTER::redact),
      |          field20 = value.field20?.let(FieldData.ADAPTER::redact),
      |          field21 = value.field21?.let(FieldData.ADAPTER::redact),
      |          field22 = value.field22?.let(FieldData.ADAPTER::redact),
      |          field23 = value.field23?.let(FieldData.ADAPTER::redact),
      |          field24 = value.field24?.let(FieldData.ADAPTER::redact),
      |          field25 = value.field25?.let(FieldData.ADAPTER::redact),
      |          field26 = value.field26?.let(FieldData.ADAPTER::redact),
      |          field27 = value.field27?.let(FieldData.ADAPTER::redact),
      |          field28 = value.field28?.let(FieldData.ADAPTER::redact),
      |          field29 = value.field29?.let(FieldData.ADAPTER::redact),
      |          field30 = value.field30?.let(FieldData.ADAPTER::redact),
      |          field31 = value.field31?.let(FieldData.ADAPTER::redact),
      |          field32 = value.field32?.let(FieldData.ADAPTER::redact),
      |          field33 = value.field33?.let(FieldData.ADAPTER::redact),
      |          field34 = value.field34?.let(FieldData.ADAPTER::redact),
      |          field35 = value.field35?.let(FieldData.ADAPTER::redact),
      |          field36 = value.field36?.let(FieldData.ADAPTER::redact),
      |          field37 = value.field37?.let(FieldData.ADAPTER::redact),
      |          field38 = value.field38?.let(FieldData.ADAPTER::redact),
      |          field39 = value.field39?.let(FieldData.ADAPTER::redact),
      |          field40 = value.field40?.let(FieldData.ADAPTER::redact),
      |          field41 = value.field41?.let(FieldData.ADAPTER::redact),
      |          field42 = value.field42?.let(FieldData.ADAPTER::redact),
      |          field43 = value.field43?.let(FieldData.ADAPTER::redact),
      |          field44 = value.field44?.let(FieldData.ADAPTER::redact),
      |          field45 = value.field45?.let(FieldData.ADAPTER::redact),
      |          field46 = value.field46?.let(FieldData.ADAPTER::redact),
      |          field47 = value.field47?.let(FieldData.ADAPTER::redact),
      |          field48 = value.field48?.let(FieldData.ADAPTER::redact),
      |          field49 = value.field49?.let(FieldData.ADAPTER::redact),
      |          field50 = value.field50?.let(FieldData.ADAPTER::redact),
      |          field51 = value.field51?.let(FieldData.ADAPTER::redact),
      |          field52 = value.field52?.let(FieldData.ADAPTER::redact),
      |          field53 = value.field53?.let(FieldData.ADAPTER::redact),
      |          field54 = value.field54?.let(FieldData.ADAPTER::redact),
      |          field55 = value.field55?.let(FieldData.ADAPTER::redact),
      |          field56 = value.field56?.let(FieldData.ADAPTER::redact),
      |          field57 = value.field57?.let(FieldData.ADAPTER::redact),
      |          field58 = value.field58?.let(FieldData.ADAPTER::redact),
      |          field59 = value.field59?.let(FieldData.ADAPTER::redact),
      |          field60 = value.field60?.let(FieldData.ADAPTER::redact),
      |          field61 = value.field61?.let(FieldData.ADAPTER::redact),
      |          field62 = value.field62?.let(FieldData.ADAPTER::redact),
      |          field63 = value.field63?.let(FieldData.ADAPTER::redact),
      |          field64 = value.field64?.let(FieldData.ADAPTER::redact),
      |          field65 = value.field65?.let(FieldData.ADAPTER::redact),
      |          field66 = value.field66?.let(FieldData.ADAPTER::redact),
      |          field67 = value.field67?.let(FieldData.ADAPTER::redact),
      |          field68 = value.field68?.let(FieldData.ADAPTER::redact),
      |          field69 = value.field69?.let(FieldData.ADAPTER::redact),
      |          field70 = value.field70?.let(FieldData.ADAPTER::redact),
      |          field71 = value.field71?.let(FieldData.ADAPTER::redact),
      |          field72 = value.field72?.let(FieldData.ADAPTER::redact),
      |          field73 = value.field73?.let(FieldData.ADAPTER::redact),
      |          field74 = value.field74?.let(FieldData.ADAPTER::redact),
      |          field75 = value.field75?.let(FieldData.ADAPTER::redact),
      |          field76 = value.field76?.let(FieldData.ADAPTER::redact),
      |          field77 = value.field77?.let(FieldData.ADAPTER::redact),
      |          field78 = value.field78?.let(FieldData.ADAPTER::redact),
      |          field79 = value.field79?.let(FieldData.ADAPTER::redact),
      |          field80 = value.field80?.let(FieldData.ADAPTER::redact),
      |          field81 = value.field81?.let(FieldData.ADAPTER::redact),
      |          field82 = value.field82?.let(FieldData.ADAPTER::redact),
      |          field83 = value.field83?.let(FieldData.ADAPTER::redact),
      |          field84 = value.field84?.let(FieldData.ADAPTER::redact),
      |          field85 = value.field85?.let(FieldData.ADAPTER::redact),
      |          field86 = value.field86?.let(FieldData.ADAPTER::redact),
      |          field87 = value.field87?.let(FieldData.ADAPTER::redact),
      |          field88 = value.field88?.let(FieldData.ADAPTER::redact),
      |          field89 = value.field89?.let(FieldData.ADAPTER::redact),
      |          field90 = value.field90?.let(FieldData.ADAPTER::redact),
      |          field91 = value.field91?.let(FieldData.ADAPTER::redact),
      |          field92 = value.field92?.let(FieldData.ADAPTER::redact),
      |          field93 = value.field93?.let(FieldData.ADAPTER::redact),
      |          field94 = value.field94?.let(FieldData.ADAPTER::redact),
      |          field95 = value.field95?.let(FieldData.ADAPTER::redact),
      |          field96 = value.field96?.let(FieldData.ADAPTER::redact),
      |          field97 = value.field97?.let(FieldData.ADAPTER::redact),
      |          field98 = value.field98?.let(FieldData.ADAPTER::redact),
      |          field99 = value.field99?.let(FieldData.ADAPTER::redact),
      |          field100 = value.field100?.let(FieldData.ADAPTER::redact)
      |        )
      |        result = redact1(result)
      |        return result
      |      }
      |
      |      private fun redact1(`value`: BazillionFields): BazillionFields = value.copy(
      |        field101 = value.field101?.let(FieldData.ADAPTER::redact),
      |        field102 = value.field102?.let(FieldData.ADAPTER::redact),
      |        field103 = value.field103?.let(FieldData.ADAPTER::redact),
      |        field104 = value.field104?.let(FieldData.ADAPTER::redact),
      |        field105 = value.field105?.let(FieldData.ADAPTER::redact),
      |        field106 = value.field106?.let(FieldData.ADAPTER::redact),
      |        field107 = value.field107?.let(FieldData.ADAPTER::redact),
      |        field108 = value.field108?.let(FieldData.ADAPTER::redact),
      |        field109 = value.field109?.let(FieldData.ADAPTER::redact),
      |        field110 = value.field110?.let(FieldData.ADAPTER::redact),
      |        field111 = value.field111?.let(FieldData.ADAPTER::redact),
      |        field112 = value.field112?.let(FieldData.ADAPTER::redact),
      |        field113 = value.field113?.let(FieldData.ADAPTER::redact),
      |        field114 = value.field114?.let(FieldData.ADAPTER::redact),
      |        field115 = value.field115?.let(FieldData.ADAPTER::redact),
      |        field116 = value.field116?.let(FieldData.ADAPTER::redact),
      |        field117 = value.field117?.let(FieldData.ADAPTER::redact),
      |        field118 = value.field118?.let(FieldData.ADAPTER::redact),
      |        field119 = value.field119?.let(FieldData.ADAPTER::redact),
      |        field120 = value.field120?.let(FieldData.ADAPTER::redact),
      |        field121 = value.field121?.let(FieldData.ADAPTER::redact),
      |        field122 = value.field122?.let(FieldData.ADAPTER::redact),
      |        field123 = value.field123?.let(FieldData.ADAPTER::redact),
      |        field124 = value.field124?.let(FieldData.ADAPTER::redact),
      |        field125 = value.field125?.let(FieldData.ADAPTER::redact),
      |        field126 = value.field126?.let(FieldData.ADAPTER::redact),
      |        field127 = value.field127?.let(FieldData.ADAPTER::redact),
      |        field128 = value.field128?.let(FieldData.ADAPTER::redact),
      |        field129 = value.field129?.let(FieldData.ADAPTER::redact),
      |        field130 = value.field130?.let(FieldData.ADAPTER::redact),
      |        field131 = value.field131?.let(FieldData.ADAPTER::redact),
      |        field132 = value.field132?.let(FieldData.ADAPTER::redact),
      |        field133 = value.field133?.let(FieldData.ADAPTER::redact),
      |        field134 = value.field134?.let(FieldData.ADAPTER::redact),
      |        field135 = value.field135?.let(FieldData.ADAPTER::redact),
      |        field136 = value.field136?.let(FieldData.ADAPTER::redact),
      |        field137 = value.field137?.let(FieldData.ADAPTER::redact),
      |        field138 = value.field138?.let(FieldData.ADAPTER::redact),
      |        field139 = value.field139?.let(FieldData.ADAPTER::redact),
      |        field140 = value.field140?.let(FieldData.ADAPTER::redact),
      |        field141 = value.field141?.let(FieldData.ADAPTER::redact),
      |        field142 = value.field142?.let(FieldData.ADAPTER::redact),
      |        field143 = value.field143?.let(FieldData.ADAPTER::redact),
      |        field144 = value.field144?.let(FieldData.ADAPTER::redact),
      |        field145 = value.field145?.let(FieldData.ADAPTER::redact),
      |        field146 = value.field146?.let(FieldData.ADAPTER::redact),
      |        field147 = value.field147?.let(FieldData.ADAPTER::redact),
      |        field148 = value.field148?.let(FieldData.ADAPTER::redact),
      |        field149 = value.field149?.let(FieldData.ADAPTER::redact),
      |        field150 = value.field150?.let(FieldData.ADAPTER::redact),
      |        unknownFields = ByteString.EMPTY
      |      )
      """.trimMargin(),
    )
