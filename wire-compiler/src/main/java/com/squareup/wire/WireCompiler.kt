 ...
 * should be placed.
 *
 * `--logger_factory_class` should be used if you want a custom [WireLogger] to be called. The factory class itself
 * should be included in your classpath.
 *
 * `--schema_handler_factory_class` should be used if you want a custom [SchemaHandler] to be called.
 * The factory class itself should be included in your classpath. If set, `custom_out` should also be
 * provided and will passed to the factory's handler as a location to where it will be able to write files.
 *
