...
public final class WireCompiler {
  ...
  static WireCompiler create(CommandLineOptions options) throws WireException {
    return new WireCompiler(options, FileSystems.getDefault(), JavaGenerator.IO.DEFAULT,
        new ConsoleWireLogger(options.quiet));
  }

  WireCompiler(CommandLineOptions options, FileSystem fs, JavaGenerator.IO javaGeneratorIo,
