...
public final class WireCompiler {
  ...
  private final Loader.IO loaderIo;
  ...
  WireCompiler(CommandLineOptions options) throws WireException {
    this(options, Loader.IO.DEFAULT, JavaGenerator.IO.DEFAULT,
        new ConsoleWireLogger(options.quiet));
  }

  WireCompiler(CommandLineOptions options, Loader.IO loaderIo, JavaGenerator.IO javaGeneratorIo,
  ...
  public void compile() throws WireException {
    ...
    Loader loader = new Loader(repoPath, loaderIo);
