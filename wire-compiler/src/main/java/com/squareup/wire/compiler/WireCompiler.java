...
public class WireCompiler {
  ...
  private void emitMessageDefaults(MessageType messageType)
    ...
    for (Field field : fields) {
      ...
      if (javaName == null) {
        throw new IllegalArgumentException("Unknown type for field " + field + " in message "
            + messageType.getName());
      }
  ...
  private String getDefaultValue(MessageType messageType, Field field) {
    ...
    } else if ("ByteString".equals(javaName)) {
      return "ByteString.of(" + (initialValue == null
          ? "\"\"" : JavaWriter.stringLiteral(initialValue)) + ")";
    } else {
      return "null";
    }
  }
