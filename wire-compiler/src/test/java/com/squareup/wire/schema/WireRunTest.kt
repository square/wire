...
class WireRunTest {
  ...
  @Test
  fun classDoesNotImplementWireLoggerInterface() {
    assertThat(
      assertFailsWith<IllegalArgumentException> {
  ...
  @Test
  fun crashWhenTypeGenerationConflicts() {
    fs.add(
      "protos/one/au.proto",
      """
          |package one;
  ...
  @Test
  fun crashWhenServiceGenerationConflicts() {
    writeRedProto()
    fs.add(
