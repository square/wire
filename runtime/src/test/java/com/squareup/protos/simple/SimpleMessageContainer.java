...
public final class SimpleMessageContainer {
  ...
  public static final Extension<ExternalMessageContainer.ExternalMessage, List<Integer>> fooext = Extension.getRepeatedExtension(ExternalMessageContainer.ExternalMessage.class, 125, Wire.INT32, false);
  public static final Extension<ExternalMessageContainer.ExternalMessage, Integer> barext = Extension.getExtension(ExternalMessageContainer.ExternalMessage.class, 126, Wire.INT32, Wire.OPTIONAL);
  public static final Extension<ExternalMessageContainer.ExternalMessage, Integer> bazext = Extension.getExtension(ExternalMessageContainer.ExternalMessage.class, 127, Wire.INT32, Wire.REQUIRED);
  public static final Extension<ExternalMessageContainer.ExternalMessage, SimpleMessage.NestedMessage> nested_message_ext = Extension.getMessageExtension(ExternalMessageContainer.ExternalMessage.class, 128, Wire.OPTIONAL, SimpleMessage.NestedMessage.class);
  public static final Extension<ExternalMessageContainer.ExternalMessage, SimpleMessage.NestedEnum> nested_enum_ext = Extension.getEnumExtension(ExternalMessageContainer.ExternalMessage.class, 129, Wire.OPTIONAL, SimpleMessage.NestedEnum.class);

  public static final class SimpleMessage
      implements Message {

    public static final Integer optional_int32_default = 123;
    public static final NestedMessage optional_nested_msg_default = Wire.getDefaultInstance(
        NestedMessage.class);
    public static final ExternalMessageContainer.ExternalMessage optional_external_msg_default = Wire
        .getDefaultInstance(ExternalMessageContainer.ExternalMessage.class);
