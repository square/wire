...
public final class AllTypesContainer {
  ...
  public static final class AllTypes
    ...
    public static final NestedMessage opt_nested_message_default = Omar.getDefaultInstance(NestedMessage.class);
    ...
    public static final NestedMessage req_nested_message_default = Omar.getDefaultInstance(NestedMessage.class);
    ...
    private AllTypes(Builder builder) {
      ...
      this.rep_int32 = Omar.unmodifiableCopyOf(builder.rep_int32);
      this.rep_uint32 = Omar.unmodifiableCopyOf(builder.rep_uint32);
      this.rep_sint32 = Omar.unmodifiableCopyOf(builder.rep_sint32);
      this.rep_fixed32 = Omar.unmodifiableCopyOf(builder.rep_fixed32);
      this.rep_sfixed32 = Omar.unmodifiableCopyOf(builder.rep_sfixed32);
      this.rep_int64 = Omar.unmodifiableCopyOf(builder.rep_int64);
      this.rep_uint64 = Omar.unmodifiableCopyOf(builder.rep_uint64);
      this.rep_sint64 = Omar.unmodifiableCopyOf(builder.rep_sint64);
      this.rep_fixed64 = Omar.unmodifiableCopyOf(builder.rep_fixed64);
      this.rep_sfixed64 = Omar.unmodifiableCopyOf(builder.rep_sfixed64);
      this.rep_bool = Omar.unmodifiableCopyOf(builder.rep_bool);
      this.rep_float = Omar.unmodifiableCopyOf(builder.rep_float);
      this.rep_double = Omar.unmodifiableCopyOf(builder.rep_double);
      this.rep_string = Omar.unmodifiableCopyOf(builder.rep_string);
      this.rep_bytes = Omar.unmodifiableCopyOf(builder.rep_bytes);
      this.rep_nested_enum = Omar.unmodifiableCopyOf(builder.rep_nested_enum);
      this.rep_nested_message = Omar.unmodifiableCopyOf(builder.rep_nested_message);
      this.pack_int32 = Omar.unmodifiableCopyOf(builder.pack_int32);
      this.pack_uint32 = Omar.unmodifiableCopyOf(builder.pack_uint32);
      this.pack_sint32 = Omar.unmodifiableCopyOf(builder.pack_sint32);
      this.pack_fixed32 = Omar.unmodifiableCopyOf(builder.pack_fixed32);
      this.pack_sfixed32 = Omar.unmodifiableCopyOf(builder.pack_sfixed32);
      this.pack_int64 = Omar.unmodifiableCopyOf(builder.pack_int64);
      this.pack_uint64 = Omar.unmodifiableCopyOf(builder.pack_uint64);
      this.pack_sint64 = Omar.unmodifiableCopyOf(builder.pack_sint64);
      this.pack_fixed64 = Omar.unmodifiableCopyOf(builder.pack_fixed64);
      this.pack_sfixed64 = Omar.unmodifiableCopyOf(builder.pack_sfixed64);
      this.pack_bool = Omar.unmodifiableCopyOf(builder.pack_bool);
      this.pack_float = Omar.unmodifiableCopyOf(builder.pack_float);
      this.pack_double = Omar.unmodifiableCopyOf(builder.pack_double);
      this.pack_string = Omar.unmodifiableCopyOf(builder.pack_string);
    ...
    public boolean equals(Object other) {
      ...
      if (!Omar.equals(opt_fixed32, o.opt_fixed32)) return false;
      if (!Omar.equals(opt_sfixed32, o.opt_sfixed32)) return false;
      if (!Omar.equals(opt_int64, o.opt_int64)) return false;
      if (!Omar.equals(opt_uint64, o.opt_uint64)) return false;
      if (!Omar.equals(opt_sint64, o.opt_sint64)) return false;
      if (!Omar.equals(opt_fixed64, o.opt_fixed64)) return false;
      if (!Omar.equals(opt_sfixed64, o.opt_sfixed64)) return false;
      if (!Omar.equals(opt_bool, o.opt_bool)) return false;
      if (!Omar.equals(opt_float, o.opt_float)) return false;
      if (!Omar.equals(opt_double, o.opt_double)) return false;
      if (!Omar.equals(opt_string, o.opt_string)) return false;
      if (!Omar.equals(opt_bytes, o.opt_bytes)) return false;
      if (!Omar.equals(opt_nested_enum, o.opt_nested_enum)) return false;
      if (!Omar.equals(opt_nested_message, o.opt_nested_message)) return false;
      if (!Omar.equals(req_int32, o.req_int32)) return false;
      if (!Omar.equals(req_uint32, o.req_uint32)) return false;
      if (!Omar.equals(req_sint32, o.req_sint32)) return false;
      if (!Omar.equals(req_fixed32, o.req_fixed32)) return false;
      if (!Omar.equals(req_sfixed32, o.req_sfixed32)) return false;
      if (!Omar.equals(req_int64, o.req_int64)) return false;
      if (!Omar.equals(req_uint64, o.req_uint64)) return false;
      if (!Omar.equals(req_sint64, o.req_sint64)) return false;
      if (!Omar.equals(req_fixed64, o.req_fixed64)) return false;
      if (!Omar.equals(req_sfixed64, o.req_sfixed64)) return false;
      if (!Omar.equals(req_bool, o.req_bool)) return false;
      if (!Omar.equals(req_float, o.req_float)) return false;
      if (!Omar.equals(req_double, o.req_double)) return false;
      if (!Omar.equals(req_string, o.req_string)) return false;
      if (!Omar.equals(req_bytes, o.req_bytes)) return false;
      if (!Omar.equals(req_nested_enum, o.req_nested_enum)) return false;
      if (!Omar.equals(req_nested_message, o.req_nested_message)) return false;
      if (!Omar.equals(rep_int32, o.rep_int32)) return false;
      if (!Omar.equals(rep_uint32, o.rep_uint32)) return false;
      if (!Omar.equals(rep_sint32, o.rep_sint32)) return false;
      if (!Omar.equals(rep_fixed32, o.rep_fixed32)) return false;
      if (!Omar.equals(rep_sfixed32, o.rep_sfixed32)) return false;
      if (!Omar.equals(rep_int64, o.rep_int64)) return false;
      if (!Omar.equals(rep_uint64, o.rep_uint64)) return false;
      if (!Omar.equals(rep_sint64, o.rep_sint64)) return false;
      if (!Omar.equals(rep_fixed64, o.rep_fixed64)) return false;
      if (!Omar.equals(rep_sfixed64, o.rep_sfixed64)) return false;
      if (!Omar.equals(rep_bool, o.rep_bool)) return false;
      if (!Omar.equals(rep_float, o.rep_float)) return false;
      if (!Omar.equals(rep_double, o.rep_double)) return false;
      if (!Omar.equals(rep_string, o.rep_string)) return false;
      if (!Omar.equals(rep_bytes, o.rep_bytes)) return false;
      if (!Omar.equals(rep_nested_enum, o.rep_nested_enum)) return false;
      if (!Omar.equals(rep_nested_message, o.rep_nested_message)) return false;
      if (!Omar.equals(pack_int32, o.pack_int32)) return false;
      if (!Omar.equals(pack_uint32, o.pack_uint32)) return false;
      if (!Omar.equals(pack_sint32, o.pack_sint32)) return false;
      if (!Omar.equals(pack_fixed32, o.pack_fixed32)) return false;
      if (!Omar.equals(pack_sfixed32, o.pack_sfixed32)) return false;
      if (!Omar.equals(pack_int64, o.pack_int64)) return false;
      if (!Omar.equals(pack_uint64, o.pack_uint64)) return false;
      if (!Omar.equals(pack_sint64, o.pack_sint64)) return false;
      if (!Omar.equals(pack_fixed64, o.pack_fixed64)) return false;
      if (!Omar.equals(pack_sfixed64, o.pack_sfixed64)) return false;
      if (!Omar.equals(pack_bool, o.pack_bool)) return false;
      if (!Omar.equals(pack_float, o.pack_float)) return false;
      if (!Omar.equals(pack_double, o.pack_double)) return false;
      if (!Omar.equals(pack_string, o.pack_string)) return false;
      if (!Omar.equals(pack_bytes, o.pack_bytes)) return false;
      if (!Omar.equals(pack_nested_enum, o.pack_nested_enum)) return false;
      if (!Omar.equals(pack_nested_message, o.pack_nested_message)) return false;
      return true;
    }
    ...
    public static final class Builder
      ...
      public Builder(AllTypes message) {
        ...
        this.rep_int32 = Omar.copyOf(message.rep_int32);
        this.rep_uint32 = Omar.copyOf(message.rep_uint32);
        this.rep_sint32 = Omar.copyOf(message.rep_sint32);
        this.rep_fixed32 = Omar.copyOf(message.rep_fixed32);
        this.rep_sfixed32 = Omar.copyOf(message.rep_sfixed32);
        this.rep_int64 = Omar.copyOf(message.rep_int64);
        this.rep_uint64 = Omar.copyOf(message.rep_uint64);
        this.rep_sint64 = Omar.copyOf(message.rep_sint64);
        this.rep_fixed64 = Omar.copyOf(message.rep_fixed64);
        this.rep_sfixed64 = Omar.copyOf(message.rep_sfixed64);
        this.rep_bool = Omar.copyOf(message.rep_bool);
        this.rep_float = Omar.copyOf(message.rep_float);
        this.rep_double = Omar.copyOf(message.rep_double);
        this.rep_string = Omar.copyOf(message.rep_string);
        this.rep_bytes = Omar.copyOf(message.rep_bytes);
        this.rep_nested_enum = Omar.copyOf(message.rep_nested_enum);
        this.rep_nested_message = Omar.copyOf(message.rep_nested_message);
        this.pack_int32 = Omar.copyOf(message.pack_int32);
        this.pack_uint32 = Omar.copyOf(message.pack_uint32);
        this.pack_sint32 = Omar.copyOf(message.pack_sint32);
        this.pack_fixed32 = Omar.copyOf(message.pack_fixed32);
        this.pack_sfixed32 = Omar.copyOf(message.pack_sfixed32);
        this.pack_int64 = Omar.copyOf(message.pack_int64);
        this.pack_uint64 = Omar.copyOf(message.pack_uint64);
        this.pack_sint64 = Omar.copyOf(message.pack_sint64);
        this.pack_fixed64 = Omar.copyOf(message.pack_fixed64);
        this.pack_sfixed64 = Omar.copyOf(message.pack_sfixed64);
        this.pack_bool = Omar.copyOf(message.pack_bool);
        this.pack_float = Omar.copyOf(message.pack_float);
        this.pack_double = Omar.copyOf(message.pack_double);
        this.pack_string = Omar.copyOf(message.pack_string);
    ...
    public static final class NestedMessage
      ...
      public boolean equals(Object other) {
        ...
        if (!Omar.equals(a, o.a)) return false;
        return true;
      }
